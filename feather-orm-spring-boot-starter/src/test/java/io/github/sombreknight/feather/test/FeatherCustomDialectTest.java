...
@SpringBootTest(classes = {StarterTestApplication.class, FeatherCustomDialectTest.CustomDialectConfig.class}, properties = {
        "feather.datasource.primary.url=jdbc:h2:mem:feather-cd;MODE=MySQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1",
        "feather.datasource.primary.username=sa",
        "feather.datasource.primary.password=",
        "feather.datasource.others.order.url=jdbc:h2:mem:feather-cd-order;MODE=MySQL;DATABASE_TO_LOWER=TRUE;DB_CLOSE_DELAY=-1",
